...
class AmstramgramAudioPlayer extends EventEmitter {
  ...
  */
  ...
  static set options(opt) {
    new Array(_classStaticPrivateFieldSpecGet(this, AmstramgramAudioPlayer, _instanceOptions), _classStaticPrivateFieldSpecGet(this, AmstramgramAudioPlayer, _srcOptions)).forEach(obj => {
      mergeDeep(obj, opt);
    });
  }
  /** 
  ...
  */
  ...
  set src(src) {
    ...
    */
    ...
    let rightSrc = params.src.find(el => el.quality && el.quality == s.getItem(`amst__${type}DefaultQuality`)) || params.src.find(el => el.default == true) || params.src[0]; //Updating the defaultQuality stored in sessionStorage
...
export default AmstramgramAudioPlayer;
